...

    {
        names: ["数据格式、语义 Web 与 API 描述", "데이터 형식, 시맨틱 웹 및 API 설명", "データ形式・セマンティック Web・API 記述"], items: [
            ...
            },
            {
                ...
                src: "https://www.w3.org/TR/2026/WD-cbor-ld-10-20260819/",
                "last-modified": "-",
                lang: "cjk",
                state: "WD"
            },
...

    {
        names: ["存储、文件与数据访问", "저장소, 파일 및 데이터 접근", "ストレージ・ファイル・データアクセス"], items: [
            ...
            },
            {
                ...
                "last-modified": "Wed, 19 Aug 2026 14:06:09 GMT",
                lang: "cjk",
                state: "Draft"
            },
            {
...

    {
        names: ["AI 和机器学习", "AI 및 머신러닝", "AI と機械学習"], items: [
            ...
            },
            {
                ...
                "last-modified": "Wed, 19 Aug 2026 18:07:51 GMT",
                lang: "cjk",
                state: "Draft"
            },
            {
...

    {
        names: ["身份、认证与凭证", "신원, 인증 및 자격 증명", "ID・認証・資格情報"], items: [
            ...
            },
            {
                ...
                src: "https://www.w3.org/TR/2026/WD-digital-credentials-20260820/",
                "last-modified": "-",
                lang: "cjk",
                state: "WD"
            },
