...
const linkGroups = [
    {
        names: ["平台核心、语言与基础设施", "플랫폼 핵심, 언어 및 기반", "プラットフォーム中核・言語・基盤"], items: [
            {
                text: "HTML",
                href: "https://htmlspecs.com/",
                src: "https://html.spec.whatwg.org/",
                "last-modified": "Tue, 22 Sep 2026 14:17:00 GMT",
                lang: "cjk",
                state: "LS"
            },
            {
            ...
            },
            {
                ...
                "last-modified": "Tue, 22 Sep 2026 21:32:28 GMT",
                lang: "cjk",
                state: "Draft"
            },
            {
            ...
            },
            {
                ...
                "last-modified": "Fri, 11 Sep 2026 07:48:32 GMT",
                lang: "cjk",
                state: "Draft"
            },
            // {
            ...
            // },
            {
                ...
                src: "https://www.w3.org/TR/2026/CRD-wasm-js-api-2-20260921/",
                "last-modified": "-",
                lang: "cjk",
                state: "CRD"
            },
            {
                ...
                src: "https://www.w3.org/TR/2026/CRD-wasm-web-api-2-20260921/",
                "last-modified": "-",
                lang: "cjk",
                state: "CRD"
            },
            ...
            },
            {
                ...
                "last-modified": "Sun, 20 Sep 2026 09:38:40 GMT",
                lang: "cjk",
                state: "LS"
            },
            {
            ...
            },
            {
                ...
                "last-modified": "Fri, 17 Jul 2026 13:17:54 GMT",
                lang: "cjk",
                state: "LS"
            },
            {
            ...
            },
            {
                ...
                src: "https://www.w3.org/TR/2026/NOTE-design-principles-20260914/",
                "last-modified": "-",
                lang: "cjk",
                state: "NOTE"
            },
    ...
    {
        names: ["统一资源标识符与媒体类型", "통합 자원 식별자 및 미디어 타입", "統一資源識別子・メディアタイプ"], items: [
            {
    ...
    {
        names: ["国际化与本地化", "국제화 및 지역화", "国際化とローカライゼーション"], items: [
            {
    ...
    {
        names: ["数据格式、语义 Web 与 API 描述", "데이터 형식, 시맨틱 웹 및 API 설명", "データ形式・セマンティック Web・API 記述"], items: [
            {
            ...
            },
            {
                ...
                src: "https://www.w3.org/TR/2026/WD-yaml-ld-10-20260920/",
                "last-modified": "-",
                lang: "cjk",
                state: "WD"
            },
            {
                ...
                src: "https://www.w3.org/TR/2026/WD-cbor-ld-10-20260916/",
                "last-modified": "-",
                lang: "cjk",
                state: "WD"
            },
            ...
            },
            {
                ...
                src: "https://www.w3.org/TR/2026/WD-lws10-core-20260921/",
                "last-modified": "-",
                lang: "cjk",
                state: "WD"
            },
            ...
            },
            {
                ...
                src: "https://www.w3.org/TR/2026/WD-lws10-authn-saml-20260803/",
                "last-modified": "-",
                lang: "cjk",
                state: "WD"
            },
            {
                ...
                src: "https://www.w3.org/TR/2026/WD-lws10-authn-ssi-cid-20260921/",
                "last-modified": "-",
                lang: "cjk",
                state: "WD"
            },
            ...
            },
            {
                ...
                src: "https://www.w3.org/TR/2026/DNOTE-rdf12-primer-20260917/",
                "last-modified": "-",
                lang: "cjk",
                state: "DNOTE"
            },
            ...
            },
            {
                ...
                src: "https://www.w3.org/TR/2026/WD-rdf12-turtle-20260914/",
                "last-modified": "-",
                lang: "cjk",
                state: "WD"
            },
            ...
            },
            {
                ...
                src: "https://www.w3.org/TR/2026/WD-sparql12-query-20260921/",
                "last-modified": "-",
                lang: "cjk",
                state: "WD"
            },
            {
                ...
                src: "https://www.w3.org/TR/2026/WD-sparql12-protocol-20260723/",
                "last-modified": "-",
                lang: "cjk",
                state: "WD"
            },
            {
                ...
                src: "https://www.w3.org/TR/2026/WD-shacl12-core-20260918/",
                "last-modified": "-",
                lang: "cjk",
                state: "WD"
            },
            ...
            {
                text: "SHACL 1.2 SPARQL-Related Features",
                href: "https://htmlspecs.com/shacl12-sparql/",
                src: "https://www.w3.org/TR/2026/WD-shacl12-sparql-20260918/",
                "last-modified": "-",
                lang: "cjk",
                state: "WD"
            },
            {
                ...
                src: "https://www.w3.org/TR/2026/WD-sparql12-rl-20260919/",
                "last-modified": "-",
                lang: "cjk",
                state: "WD"
            },
            ...
            },
            {
                ...
                "last-modified": "Mon, 21 Sep 2026 09:51:15 GMT",
                lang: "cjk",
                state: "Draft"
            },
            {
    ...
    {
        names: ["语法记法与时间格式", "구문 표기법 및 시간 형식", "構文記法・時刻フォーマット"], items: [
            {
    ...
    {
        names: ["Web 应用、安装与生命周期", "웹 앱, 설치 및 수명주기", "Web アプリ・インストール・ライフサイクル"], items: [
            {
            ...
            },
            {
                ...
                "last-modified": "Tue, 04 Aug 2026 23:51:11 GMT",
                lang: "cjk",
                state: "Draft"
            },
            {
            ...
            },
            {
                ...
                src: "https://www.w3.org/TR/2026/CRD-service-workers-20260917/",
                "last-modified": "-",
                lang: "cjk",
                state: "CRD"
            },
    ...
    {
        names: ["网络、传输与实时通信", "네트워크, 전송 및 실시간 통신", "ネットワーク・転送・リアルタイム通信"], items: [
            {
                text: "Fetch",
                href: "https://htmlspecs.com/fetch/",
                src: "https://fetch.spec.whatwg.org/",
                "last-modified": "Mon, 21 Sep 2026 06:15:56 GMT",
                lang: "cjk",
                state: "LS"
            },
            {
    ...
    {
        names: ["离线、后台与通知", "오프라인, 백그라운드 및 알림", "オフライン・バックグラウンド・通知"], items: [
            {
    ...
    {
        names: ["存储、文件与数据访问", "저장소, 파일 및 데이터 접근", "ストレージ・ファイル・データアクセス"], items: [
            {
            ...
            },
            {
                ...
                "last-modified": "Tue, 22 Sep 2026 14:34:22 GMT",
                lang: "cjk",
                state: "Draft"
            },
            {
    ...
    {
        names: ["输入、编辑与剪贴板", "입력, 편집 및 클립보드", "入力・編集・クリップボード"], items: [
            {
            ...
            },
            {
                ...
                src: "https://www.w3.org/TR/2026/SPSD-pointerevents2-20260630/",
                "last-modified": "-",
                lang: "cjk",
                state: "SPSD"
            },
            {
                ...
                src: "https://www.w3.org/TR/2026/REC-pointerevents3-20260630/",
                "last-modified": "-",
                lang: "cjk",
                state: "REC"
            },
            ...
            },
            {
                ...
                src: "https://www.w3.org/TR/2026/WD-clipboard-apis-20260624/",
                "last-modified": "-",
                lang: "cjk",
                state: "WD"
            },
    ...
    {
        names: ["设备、传感器与硬件接口", "기기, 센서 및 하드웨어 인터페이스", "デバイス・センサー・ハードウェアインターフェイス"], items: [
            {
                text: "Web Serial API",
    ...
    {
        names: ["Web of Things 与物联网", "Web of Things 및 사물인터넷", "Web of Things・IoT"], items: [
            {
    ...
    {
        names: ["窗口、屏幕与系统集成", "창, 화면 및 시스템 통합", "ウィンドウ・画面・システム統合"], items: [
            {
                text: "Screen Orientation",
                href: "https://htmlspecs.com/screen-orientation/",
                src: "https://www.w3.org/TR/2026/WD-screen-orientation-20260806/",
                "last-modified": "-",
                lang: "cjk",
                state: "WD"
            },
            ...
            },
            {
                ...
                "last-modified": "Fri, 17 Jul 2026 13:21:50 GMT",
                lang: "cjk",
                state: "LS"
            },
            {
            ...
            },
            {
                ...
                src: "https://www.w3.org/TR/2026/WD-window-management-20260908/",
                "last-modified": "-",
                lang: "cjk",
                state: "WD"
            },
    ...
    {
        names: ["音频、语音与媒体控制", "오디오, 음성 및 미디어 제어", "音声・スピーチ・メディア制御"], items: [
            {
                text: "Web Speech API",
                href: "https://htmlspecs.com/web-speech-api/",
                src: "https://webaudio.github.io/web-speech-api/",
                "last-modified": "Fri, 18 Sep 2026 16:43:01 GMT",
                lang: "cjk",
                state: "Draft"
            },
            {
    ...
    {
        names: ["音视频采集、WebRTC 与播放", "오디오/비디오 캡처, WebRTC 및 재생", "音声映像キャプチャ・WebRTC・再生"], items: [
            {
                text: "WebRTC",
            ...
            },
            {
                ...
                src: "https://www.w3.org/TR/2026/WD-webrtc-encoded-transform-20260625/",
                "last-modified": "-",
                lang: "cjk",
                state: "WD"
            },
            ...
            },
            {
                ...
                src: "https://www.w3.org/TR/2026/WD-encrypted-media-2-20260707/",
                "last-modified": "-",
                lang: "cjk",
                state: "WD"
            },
    ...
    {
        names: ["媒体格式、字幕与编解码", "미디어 형식, 자막 및 코덱", "メディア形式・字幕・コーデック"], items: [
            {
    ...
    {
        names: ["图形、图像、GPU 与 WebXR", "그래픽, 이미지, GPU 및 WebXR", "グラフィックス・画像・GPU・WebXR"], items: [
            {
                ...
                "last-modified": "Sat, 12 Sep 2026 02:31:00 GMT",
                lang: "cjk",
                state: "Draft"
            },
            {
                ...
                src: "https://www.w3.org/TR/2026/CRD-webgpu-20260915/",
                "last-modified": "-",
                lang: "cjk",
                state: "CRD"
            },
            {
                ...
                src: "https://www.w3.org/TR/2026/CRD-WGSL-20260921/",
                "last-modified": "-",
                lang: "cjk",
                state: "CRD"
            },
    ...
    {
        names: ["AI 和机器学习", "AI 및 머신러닝", "AI と機械学習"], items: [
            {
                text: "Web Neural Network API",
                href: "https://htmlspecs.com/webnn/",
                src: "https://www.w3.org/TR/2026/CRD-webnn-20260910/",
                "last-modified": "-",
                lang: "cjk",
                state: "CRD"
            },
            {
                ...
                "last-modified": "Thu, 17 Sep 2026 14:45:57 GMT",
                lang: "cjk",
                state: "Draft"
            },
            {
            ...
            },
            {
                ...
                "last-modified": "Mon, 10 Aug 2026 21:06:51 GMT",
                lang: "cjk",
                state: "Draft"
            },
            {
                ...
                "last-modified": "Tue, 22 Sep 2026 00:10:00 GMT",
                lang: "cjk",
                state: "Draft"
            },
            {
    ...
    {
        names: ["性能时间线、指标与观测", "성능 타임라인, 지표 및 관측", "パフォーマンスタイムライン・指標・観測"], items: [
            {
    ...
    {
        names: ["调度、生命周期、预加载与报告", "스케줄링, 수명주기, 사전 로드 및 보고", "スケジューリング・ライフサイクル・プリロード・レポート"], items: [
            {
                text: "Observable",
    ...
    {
        names: ["安全、内容防护与策略", "보안, 콘텐츠 보호 및 정책", "セキュリティ・コンテンツ防護・ポリシー"], items: [
            {
            ...
            },
            {
                ...
                "last-modified": "Mon, 14 Sep 2026 16:26:36 GMT",
                lang: "cjk",
                state: "Draft"
            },
            // {
            ...
            },
            {
                ...
                src: "https://www.w3.org/TR/2026/DNOTE-threat-model-web-20260922/",
                "last-modified": "-",
                lang: "cjk",
                state: "DNOTE"
            },
    ...
    {
        names: ["身份、认证与凭证", "신원, 인증 및 자격 증명", "ID・認証・資格情報"], items: [
            {
                text: "WebOTP API",
            ...
            },
            {
                ...
                src: "https://www.w3.org/TR/2026/WD-digital-credentials-20260904/",
                "last-modified": "-",
                lang: "cjk",
                state: "WD"
            },
            ...
            },
            {
                ...
                src: "https://www.w3.org/TR/2026/WD-vcalm-1.0-20260821/",
                "last-modified": "-",
                lang: "cjk",
                state: "WD"
            },
            ...
            },
            {
                ...
                src: "https://www.w3.org/TR/2026/WD-vc-barcodes-1.0-20260822/",
                "last-modified": "-",
                lang: "cjk",
                state: "WD"
            },
            {
                ...
                src: "https://www.w3.org/TR/2026/WD-vc-recognized-entities-1.0-20260906/",
                "last-modified": "-",
                lang: "cjk",
                state: "WD"
            },
    ...
    {
        names: ["OAuth 与授权协议", "OAuth 및 인가 프로토콜", "OAuth・認可プロトコル"], items: [
            {
    ...
    {
        names: ["隐私、权限与反跟踪", "프라이버시, 권한 및 추적 방지", "プライバシー・権限・トラッキング対策"], items: [
            {
                text: "Permissions",
            ...
            },
            {
                ...
                src: "https://www.w3.org/TR/2026/WD-attribution-20260910/",
                "last-modified": "-",
                lang: "cjk",
                state: "WD"
            },
    ...
    {
        names: ["支付与数字商品", "결제 및 디지털 상품", "決済・デジタル商品"], items: [
            {
            ...
            },
            {
                ...
                src: "https://www.w3.org/TR/2026/CRD-secure-payment-confirmation-20260702/",
                "last-modified": "-",
                lang: "cjk",
                state: "CRD"
            },
    ...
    {
        names: ["数字出版与电子书", "디지털 출판 및 전자책", "デジタル出版・電子書籍"], items: [
            {
                text: "EPUB 3.3",
    ...
    {
        names: ["开发者工具、测试与自动化", "개발자 도구, 테스트 및 자동화", "開発者ツール・テスト・自動化"], items: [
            {
                text: "Test Utils",
            ...
            },
            {
                ...
                src: "https://www.w3.org/TR/2026/WD-webdriver2-20260702/",
                "last-modified": "-",
                lang: "cjk",
                state: "WD"
            },
            {
                ...
                src: "https://www.w3.org/TR/2026/WD-webdriver-bidi-20260916/",
                "last-modified": "-",
                lang: "cjk",
                state: "WD"
            }
...
const cssLinkGroups = [
    ...
    {
        names: ["语法、级联、选择器与值", "구문, 캐스케이드, 선택자 및 값", "構文・カスケード・セレクター・値"], items: [
            {
    ...
    {
        names: ["颜色、背景、边框与视觉效果", "색상, 배경, 테두리 및 시각 효과", "色・背景・境界・視覚効果"], items: [
            {
            ...
            },
            {
                ...
                src: "https://www.w3.org/TR/2026/WD-css-color-hdr-1-20260907/",
                "last-modified": "-",
                lang: "cjk",
                state: "WD"
            },
    ...
    {
        names: ["字体、文本、列表与书写模式", "글꼴, 텍스트, 목록 및 쓰기 모드", "フォント・テキスト・リスト・書字方向"], items: [
            {
    ...
    {
        names: ["布局、盒模型与定位", "레이아웃, 박스 모델 및 위치 지정", "レイアウト・ボックスモデル・配置"], items: [
            {
            ...
            },
            {
                ...
                src: "https://www.w3.org/TR/2026/WD-css-sizing-4-20260904/",
                "last-modified": "-",
                lang: "cjk",
                state: "WD"
            },
    ...
    {
        names: ["分页、分栏、分片与生成内容", "페이지, 다단, 단편화 및 생성 콘텐츠", "ページ・段組み・断片化・生成コンテンツ"], items: [
            {
    ...
    {
        names: ["滚动、溢出、视口与空间导航", "스크롤, 오버플로, 뷰포트 및 공간 내비게이션", "スクロール・オーバーフロー・ビューポート・空間ナビゲーション"], items: [
            {
    ...
    {
        names: ["图像、遮罩与图形装饰", "이미지, 마스킹 및 그래픽 장식", "画像・マスク・グラフィック装飾"], items: [
            {
    ...
    {
        names: ["动画、变换、过渡与视图切换", "애니메이션, 변환, 전환 및 뷰 전환", "アニメーション・変形・遷移・ビュー遷移"], items: [
            {
    ...
    {
        names: ["条件、容器、作用域与响应式", "조건, 컨테이너, 스코프 및 반응형", "条件・コンテナー・スコープ・レスポンシブ"], items: [
            {
    ...
    {
        names: ["UI、表单、高亮与用户交互", "UI, 폼, 하이라이트 및 사용자 상호작용", "UI・フォーム・ハイライト・ユーザー操作"], items: [
            {
    ...
    {
        names: ["CSSOM、Houdini 与自定义扩展", "CSSOM, Houdini 및 사용자 정의 확장", "CSSOM・Houdini・カスタム拡張"], items: [
            {
    ...
    {
        names: ["设计令牌", "디자인 토큰", "デザイントークン"], items: [
            {
...
const cssLinks = cssLinkGroups.flatMap(group => group.items);

const httpLinkGroups = [

    {
        names: ["HTTP", "HTTP", "HTTP"], items: [
            {
                text: "index",
    ...
    {
        names: ["HTTP 核心、版本与压缩", "HTTP 핵심, 버전 및 압축", "HTTP 中核・バージョン・圧縮"], items: [
            {
                text: "HTTP Semantics",
    ...
    {
        names: ["方法、状态码与协议构建", "메서드, 상태 코드 및 프로토콜 구축", "メソッド・ステータスコード・プロトコル構築"], items: [
            {
    ...
    {
        names: ["缓存与重用", "캐시 및 재사용", "キャッシュと再利用"], items: [
            {
    ...
    {
        names: ["表示元数据、链接与内容编码", "표현 메타데이터, 링크 및 콘텐츠 인코딩", "表現メタデータ・リンク・内容エンコーディング"], items: [
            {
    ...
    {
        names: ["客户端提示、偏好与优先级", "클라이언트 힌트, 선호 및 우선순위", "クライアントヒント・優先・優先度"], items: [
            {
    ...
    {
        names: ["连接、中介、代理与隧道", "연결, 중개자, 프록시 및 터널", "接続・仲介・プロキシ・トンネル"], items: [
            {
    ...
    {
        names: ["认证、签名与安全", "인증, 서명 및 보안", "認証・署名・セキュリティ"], items: [
            {
    ...
    {
        names: ["传输层与连接安全", "전송 계층 및 연결 보안", "トランスポート層・接続セキュリティ"], items: [
            {
...
const httpLinks = httpLinkGroups.flatMap(group => group.items);
